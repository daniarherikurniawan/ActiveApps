...
import activeapps.Computerise.CountdownTimerListener;
 ...
 * @author daniar heri
 */
public class AMQPanel extends ImagePanelBackGround {

    /**
     * Creates new form AMQPanel
     */
    private int DefaultTime = 90*60 ; // detik
    Timer countdownTimer ;
    public AMQPanel(String Path) {
        super(Path);
        initComponents();
        countdownTimer = new Timer(1000, new AMQPanel.CountdownTimerListener(DefaultTime));
